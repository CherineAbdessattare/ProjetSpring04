...
public class EtudiantController {
	...
	/*
	 * @RequestMapping("/saveEtudiant") public String saveEtudiant(@Valid Etudiant
	 * etudiant, BindingResult bindingResult,@ModelAttribute("page") int
	 * pageFromPrevious, RedirectAttributes redirectAttributes,
	 * 
	 * @RequestParam (name="size", defaultValue = "2") int size) {
	 * 
	 * int page; if (bindingResult.hasErrors()) return "formEtudiant"; if
	 * (etudiant.getIdEtudiant()==null) //adding page =
	 * etudiantService.getAllEtudiants().size()/size; // calculer le nbr de pages
	 * else //updating page = pageFromPrevious;
	 * etudiantService.saveEtudiant(etudiant);
	 * 
	 * 
	 * 
	 * redirectAttributes.addAttribute("page", page); return
	 * "redirect:ListeEtudiants"; }
	 */
	
	
	@RequestMapping("/saveEtudiant")
	public String saveProduit(@Valid Etudiant etudiant,
							  BindingResult bindingResult,
							  ...
							  )
	{
		  ...
		  int page;
		    ...
		    if (etudiant.getIdEtudiant()==null) //adding
		        page = etudiantService.getAllEtudiants().size()/size; // calculer le nbr de pages
		    else //updating
...
@RequestMapping("/modifierEtudiant")
	public String editerEtudiant(@RequestParam("id") Long id,@RequestParam("page") int page,ModelMap modelMap)
	{
	List<Departement> departs = etudiantService.getAllDepartements();
